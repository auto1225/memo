...
figure.jan-fig figcaption::before {
...
figure.jan-tbl figcaption::before {
...
<div class="jan-paper" spellcheck="false">
  ...
  <section class="jan-page" id="page-2">
    ...
    <div class="jan-two-col" contenteditable="true">
      ...
      <figure class="jan-fig" id="fig2">
        <div class="jan-fig-placeholder">
          [그림 2 자리 — 실험 프로토콜 순서도: MOT 로딩 → 증발냉각 → BEC 생성 → 광격자 램프 → Raman 결합 → 방향 선택 → Bragg 펄스 → 자유 팽창 → 흡수 이미징 → 공명 판정 → 반복. Mermaid 로 그려진 flowchart 자동 렌더 위치.]
        </div>
      ...
      <figure class="jan-fig" id="fig3">
        <div class="jan-fig-placeholder">
          [그림 3 자리 — 장치 블록 다이어그램: Ti:Sa 1064nm → AOM1 → 격자 광학계, Diode 790nm → AOM2 → Raman 모듈, → 진공 챔버 (&lt;2×10⁻¹¹ Torr) ← RF 안테나, → CCD 이미징 → DAQ (1 GS/s) → 분석 PC.]
        </div>
  ...
  <section class="jan-page" id="page-3">
    ...
    <div class="jan-two-col" contenteditable="true">
      ...
      <figure class="jan-fig" id="fig5">
        <div class="jan-fig-placeholder">
          [그림 5 자리 — 핵심 결과 인포그래픽. 중앙 큰 숫자 𝒞 = 0.97 ± 0.04 둘레에 비등방 비율 34, 원자 수 10⁵, 18 샷 평균, 4% 일치 배치.]
        </div>
