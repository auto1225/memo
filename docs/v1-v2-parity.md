...
| Business cards | Scan/upload, SNS fields, vCard, duplicate checks, stats | In progress | Dedicated v2 manager now supports image upload/camera/drop/paste, rotate/clear, OCR/AI extraction, SNS fields, search, duplicate checks, stats, my-card QR, memo insertion, CSV/vCard import/export, meeting logs. Remaining audit: real-device camera and v1 mention links. |
